...
emailAuth.post(
  ...
  async function (req, res, next) {
    ...
    if (req.body.newpassword !== req.body.confirmpassword) { return response.errorBadRequest(req, res) }
    ...
    if (!(await user.verifyPassword(req.body.password))) { return response.errorBadRequest(req, res) }
