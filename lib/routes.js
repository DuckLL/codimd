...
// admin
appRouter.get('/admin', admin.index)
appRouter.post('/admin/setAdmin', bodyParser.json(), admin.setAdmin)
appRouter.post('/admin/resetPassword', bodyParser.json(), admin.resetPassword)

// note index
appRouter.get('/notes/:page?', extension.notepage)
...
// content search
appRouter.get('/api/search', searchController.searchNote)
// get note by id
