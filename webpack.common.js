...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/index-pack-header.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/index-pack-scripts.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/cover-pack-header.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/cover-pack-scripts.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/pretty-pack-header.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/pretty-pack-scripts.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/slide-pack-header.ejs"
      ),
      inject: false,
      chunksSortMode: "manual",
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      filename: path.join(
        __dirname,
        "public/views/build/slide-pack-scripts.ejs"
      ),
      inject: false,
    }),
    new HtmlWebpackPlugin({
      template: "public/views/includes/scripts.ejs",
      chunks: ["common", "admin-pack"],
      filename: path.join(
        __dirname,
        "public/views/build/admin-pack-scripts.ejs"
      ),
      inject: false,
    }),
  ...
  entry: {
    ...
    "index-styles": [
      ...
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/lib/codemirror.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/addon/fold/foldgutter.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/addon/display/fullscreen.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/addon/dialog/dialog.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/addon/scroll/simplescrollbars.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/addon/search/matchesonscrollbar.css"
      ),
      path.join(__dirname, "node_modules/@hackmd/codemirror/theme/monokai.css"),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/theme/one-dark.css"
      ),
      path.join(__dirname, "node_modules/@hackmd/codemirror/theme/dracula.css"),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/theme/material.css"
      ),
      path.join(__dirname, "node_modules/@hackmd/codemirror/theme/nord.css"),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/theme/panda-syntax.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/theme/solarized.css"
      ),
      ...
      path.join(
        __dirname,
        "public/css/codemirror-extend/tomorrow-night-eighties.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/mode/tiddlywiki/tiddlywiki.css"
      ),
      path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/mode/mediawiki/mediawiki.css"
      ),
  ...
  resolve: {
    ...
    alias: {
      codemirror: path.join(
        __dirname,
        "node_modules/@hackmd/codemirror/codemirror.min.js"
      ),
      inlineAttachment: path.join(
        __dirname,
        "public/vendor/inlineAttachment/inline-attachment.js"
      ),
      jqueryTextcomplete: path.join(
        __dirname,
        "public/vendor/jquery-textcomplete/jquery.textcomplete.js"
      ),
      codemirrorInlineAttachment: path.join(
        __dirname,
      ...
      "jquery-ui-resizable": path.join(
        __dirname,
        "public/vendor/jquery-ui/jquery-ui.min.js"
      ),
      "gist-embed": path.join(
        __dirname,
        "node_modules/gist-embed/gist-embed.min.js"
      ),
      "bootstrap-tooltip": path.join(
        __dirname,
      ...
      "js-sequence-diagrams": path.join(
        __dirname,
        "node_modules/@hackmd/js-sequence-diagrams/build/main.js"
      ),
      ...
      "vega-embed": path.join(
        __dirname,
        "node_modules/vega-embed/build/vega-embed.min.js"
      ),
      "emojify.js": path.join(
        __dirname,
        "node_modules/@hackmd/emojify.js/dist/js/emojify-browser.min.js"
      ),
      ...
      "viz.render.js": path.join(
        __dirname,
        "node_modules/viz.js/full.render.js"
      ),
      markdownlint: path.join(
        __dirname,
        "node_modules/markdownlint/demo/markdownlint-browser.js"
      ),
    },
  },
